const webProducts = [
    ...
    },
    {
        ...
        img: 'https://storage.yandexcloud.net/mywebpageresources/window.png',
        stack: 'Приложение для формирования списка задач с возможнстью редактирования по статусу выпонения и удаления выполеннных задач из списка.<br/><br/> Стек: TypeScript, React, NextJS.<br/><br/> Адаптация: под различные устройства.<br/><br/> Развертывание: Vercel',
        category: 'frontend',
    },
    {
        id: 'kinopoisk',
        ...
        img: 'https://storage.yandexcloud.net/mywebpageresources/window.png',
        stack: 'Приложение для просмотра данных о фильмах, поиска (с фильтрами) и добавление фильмов в избранное. <br/><br/> Стек: TypeScript, React, NextJS, API Кинопоиск. <br/><br/> Адаптация: под различные устройства.<br/><br/> Развертывание: Vercel',
        category: 'frontend',
    },
];
